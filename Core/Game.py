...
class Game(object):
    ...
    def debug(self):
        ...
        t.add_card_to_group(self.players[1].giveCard(1), 0)
        print('    Groups printout')
        print(t.groups)
        print('    Group printout')
        print(t.groups[1])
        print('\n\n\n    Add Three cards to group[1]')
        t.add_card_to_group(self.players[1].giveCard(3), 1)
        t.add_card_to_group(self.players[1].giveCard(2), 1)
        t.add_card_to_group(self.players[1].giveCard(0), 1)
        print('    Groups printout')
        print(t.groups)
        print('    Group printout')
        print(t.groups[1])
